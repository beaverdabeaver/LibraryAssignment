...
public class Author {
	...
	public void setLastModified(LocalDateTime localDateTime){ this.lastModified = localDateTime; }
	...
	public Boolean isModified(int id, LocalDateTime time) {try {
		return gateway.isModified(id, time);
	} catch (Exception e) {
		// TODO Auto-generated catch block
		//e.printStackTrace();
		logger.error("this is a new author");
		return false;
	}}
