...
public class AuthorDetailController implements Initializable{
	...
	void saveButtonClicked(MouseEvent event){
		...
		if(!author.isValidFirstName(author.getFirstName())) {
			...
			if(!author.getFirstName().equals(origFirstName) && !author.isValidID(author.getId())){
				try {
			...
			if(!author.getLastName().equals(origLastName) && !author.isValidID(author.getId())){
				try {
			...
			if(!author.getDob().equals(origDate) && !author.isValidID(author.getId())){
				try {
			...
			if(!author.getGender().equals(origGender) && !author.isValidID(author.getId())){
				try {
			...
			if(!author.getWebsite().equals(origWebsite) && !author.isValidID(author.getId())){
				try {
